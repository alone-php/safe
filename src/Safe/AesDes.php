...
use AlonePack\Phpseclib3\Crypt\TripleDES as DES3;
...
trait AesDes {
    ...
    public function data(string $key, mixed $default = ''): mixed {
        return static::getArr($this->data, $key, $default);
    }
    ...
    public function list(string $key, mixed $default = ''): mixed {
        return static::getArr($this->list, strtoupper($this->data('type')) . '.' . $key, $default);
    }
