 ...
 * <code>
 * <?php
 *    $a = new \AlonePack\Phpseclib3\Math\BigInteger(2);
 *    $b = new \AlonePack\Phpseclib3\Math\BigInteger(3);
 *
 *    $c = $a->add($b);
 *
...
namespace AlonePack\Phpseclib3\Math;

use AlonePack\Phpseclib3\Exception\BadConfigurationException;
use AlonePack\Phpseclib3\Math\BigInteger\Engines\Engine;
...
class BigInteger implements \JsonSerializable
{
     ...
     * <code>
     * <?php
     *    $a = new \AlonePack\Phpseclib3\Math\BigInteger('10');
     *    $b = new \AlonePack\Phpseclib3\Math\BigInteger('20');
     *
