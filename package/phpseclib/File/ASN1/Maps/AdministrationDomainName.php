...
abstract class AdministrationDomainName
{
    const MAP = [
        ...
        // if class isn't present it's assumed to be \AlonePack\Phpseclib3\File\ASN1::CLASS_UNIVERSAL or
        // (if constant is present) \AlonePack\Phpseclib3\File\ASN1::CLASS_CONTEXT_SPECIFIC
