...
namespace AlonePack\Phpseclib3\System\SSH\Agent;
...
use AlonePack\Phpseclib3\System\SSH\Common\Traits\ReadBytes;

/**
 * Pure-PHP ssh-agent client identity object
 *
 * Instantiation should only be performed by \AlonePack\Phpseclib3\System\SSH\Agent class.
 * This could be thought of as implementing an interface that AlonePack\Phpseclib3\Crypt\RSA
...
class Identity implements PrivateKey
{
     ...
     * Set Public Key
     *
     * Called by \AlonePack\Phpseclib3\System\SSH\Agent::requestIdentities()
     *
     * @param PublicKey $key
     */
     ...
     * Set Public Key
     *
     * Called by \AlonePack\Phpseclib3\System\SSH\Agent::requestIdentities(). The key blob could be extracted from $this->key
