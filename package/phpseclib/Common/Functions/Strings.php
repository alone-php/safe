...
namespace AlonePack\Phpseclib3\Common\Functions;

use AlonePack\ParagonIE\\ConstantTime\Base64;
use AlonePack\ParagonIE\\ConstantTime\Base64UrlSafe;
use AlonePack\ParagonIE\\ConstantTime\Hex;
use AlonePack\Phpseclib3\Math\BigInteger;
use AlonePack\Phpseclib3\Math\Common\FiniteField;
            ...
            switch ($format[$i]) {
                ...
                case 'i':
                    if (!$element instanceof BigInteger && !$element instanceof FiniteField\Integer) {
                        throw new \InvalidArgumentException('A AlonePack\Phpseclib3\Math\BigInteger or AlonePack\Phpseclib3\Math\Common\FiniteField\Integer object was expected.');
                    }
