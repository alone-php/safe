 ...
 *
 *    $ssh = new \AlonePack\Phpseclib3\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = \AlonePack\Phpseclib3\Crypt\PublicKeyLoader::load('...', '(optional) password');
 *
 *    $ssh = new \AlonePack\Phpseclib3\Net\SSH2('www.domain.tld');
...
namespace AlonePack\Phpseclib3\Net;

use AlonePack\Phpseclib3\Common\Functions\Strings;
use AlonePack\Phpseclib3\Crypt\Blowfish;
use AlonePack\Phpseclib3\Crypt\ChaCha20;
use AlonePack\Phpseclib3\Crypt\Common\AsymmetricKey;
use AlonePack\Phpseclib3\Crypt\Common\PrivateKey;
use AlonePack\Phpseclib3\Crypt\Common\PublicKey;
use AlonePack\Phpseclib3\Crypt\Common\SymmetricKey;
use AlonePack\Phpseclib3\Crypt\DH;
use AlonePack\Phpseclib3\Crypt\DSA;
use AlonePack\Phpseclib3\Crypt\EC;
use AlonePack\Phpseclib3\Crypt\Hash;
use AlonePack\Phpseclib3\Crypt\Random;
use AlonePack\Phpseclib3\Crypt\RC4;
use AlonePack\Phpseclib3\Crypt\Rijndael;
use AlonePack\Phpseclib3\Crypt\RSA;
use AlonePack\Phpseclib3\Crypt\TripleDES; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use AlonePack\Phpseclib3\Crypt\Twofish;
use AlonePack\Phpseclib3\Exception\ConnectionClosedException;
use AlonePack\Phpseclib3\Exception\InsufficientSetupException;
use AlonePack\Phpseclib3\Exception\InvalidPacketLengthException;
use AlonePack\Phpseclib3\Exception\NoSupportedAlgorithmsException;
use AlonePack\Phpseclib3\Exception\TimeoutException;
use AlonePack\Phpseclib3\Exception\UnableToConnectException;
use AlonePack\Phpseclib3\Exception\UnsupportedAlgorithmException;
use AlonePack\Phpseclib3\Exception\UnsupportedCurveException;
use AlonePack\Phpseclib3\Math\BigInteger;
use AlonePack\Phpseclib3\System\SSH\Agent;
...
class SSH2
{
     ...
     *     the other side.
     *
     * @see \AlonePack\Phpseclib3\Net\SSH2::send_channel_packet()
     * @see \AlonePack\Phpseclib3\Net\SSH2::get_channel_packet()
     */
     ...
     *
     * @see \AlonePack\Phpseclib3\Net\SSH2::getLog()
     */
    const LOG_SIMPLE = 1;
    /**
     ...
     *
     * @see \AlonePack\Phpseclib3\Net\SSH2::read()
     */
    const READ_SIMPLE = 1;
    /**
     ...
     * \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey.
     *
     * @param string $algorithm Name of the encryption algorithm
    ...
    /**
     * Maps an encryption algorithm name to an instance of a subclass of
     * \AlonePack\Phpseclib3\Crypt\Hash.
     *
     * @param string $algorithm Name of the encryption algorithm
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \AlonePack\Phpseclib3\Crypt\RSA|EC|DSA object, a \AlonePack\Phpseclib3\System\SSH\Agent object or an array
     *
        ...
        foreach ($args as $arg) {
            switch (true) {
                ...
                case Strings::is_stringable($arg):
                    break;
                default:
                    throw new \UnexpectedValueException('$password needs to either be an instance of \AlonePack\Phpseclib3\Crypt\Common\PrivateKey, \System\SSH\Agent, an array or a string');
            }
        }
        ...
        if ($publickey instanceof RSA) {
            ...
            switch ($curveName) {
                ...
                default:
                    ...
                    throw new UnsupportedCurveException('Named Curve of ' . $curveName . ' is not supported by AlonePack\Phpseclib3\'s SSH2 implementation');
            }
     ...
     * Execute Command
     *
     * If $callback is set to false then \AlonePack\Phpseclib3\Net\SSH2::get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    public function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \AlonePack\Phpseclib3\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \AlonePack\Phpseclib3\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
