...
namespace AlonePack\Phpseclib3\Net\SFTP;

use AlonePack\Phpseclib3\Crypt\Common\PrivateKey;
use AlonePack\Phpseclib3\Net\SFTP;
use AlonePack\Phpseclib3\Net\SSH2;
...
class Stream
{
    ...
    protected function parse_path($path)
    {
        ...
        if (preg_match('/^{[a-z0-9]+}$/i', $host)) {
            ...
            // casting $pass to a string is necessary in the event that it's a \AlonePack\Phpseclib3\Crypt\RSA object
     ...
     * If newname exists, it will be overwritten.  This is a departure from what \AlonePack\Phpseclib3\Net\SFTP
     * does.
     *
     ...
     * Flushes the output
     *
     * See <http://php.net/fflush>. Always returns true because \AlonePack\Phpseclib3\Net\SFTP doesn't cache stuff before writing
     *
     * @return bool
     */
     ...
     *
     * Ignores the STREAM_URL_STAT_QUIET flag because the entirety of \AlonePack\Phpseclib3\Net\SFTP\Stream is quiet by default
     ...
     * The other two aren't supported because of limitations in \AlonePack\Phpseclib3\Net\SFTP.
     *
     * @param int $option
     * @param int $arg1
     * @param int $arg2
