 ...
 *
 *    $sftp = new \AlonePack\Phpseclib3\Net\SFTP('www.domain.tld');
...
use AlonePack\Phpseclib3\Exception\FileNotFoundException;
...
class SFTP extends SSH2
{
     ...
     *
     * \AlonePack\Phpseclib3\Net\SSH2::exec() uses 0 and \AlonePack\Phpseclib3\Net\SSH2::read() / \AlonePack\Phpseclib3\Net\SSH2::write() use 1.
     *
     ...
     *
     * @see \AlonePack\Phpseclib3\Net\SFTP::put()
     */
    ...
    public function __construct($host, $port = 22, $timeout = 10)
    {
        ...
        if (empty(self::$packet_types)) {
            ...
            // the order, in this case, matters quite a lot - see \AlonePack\Phpseclib3\Net\SFTP::_parseAttributes() to understand why
            self::$attributes = [
            ...
            // see \AlonePack\Phpseclib3\Net\SFTP::_parseLongname() for an explanation
            self::$file_types = [
    ...
    private function init_sftp_connection()
    {
        ...
        /*
         ...
         in draft-ietf-secsh-filexfer-13 would be quite impossible.  As such, what \AlonePack\Phpseclib3\Net\SFTP would do is close the
    ...
    public function chdir($dir)
    {
        ...
        // see \AlonePack\Phpseclib3\Net\SFTP::nlist() for a more thorough explanation of the following
        $response = $this->get_sftp_packet();
        switch ($this->packet_type) {
     ...
     * Returns general information about a file or symbolic link
     *
     * Determines information without calling \AlonePack\Phpseclib3\Net\SFTP::realpath().
     ...
     *
     * By default, \AlonePack\Phpseclib3\Net\SFTP::put() does not read from the local filesystem.  $data is dumped directly into $remote_file.
     * So, for example, if you set $data to 'filename.ext' and then do \AlonePack\Phpseclib3\Net\SFTP::get(), you will get a file, twelve bytes
     ...
     *
     * {@internal ASCII mode for SFTPv4/5/6 can be supported by adding a new function - \AlonePack\Phpseclib3\Net\SFTP::setMode().}
     *
