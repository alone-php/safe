 ...
 *
 *    $rijndael = new \AlonePack\Phpseclib3\Crypt\Rijndael('ctr');
 *
...
class Rijndael extends BlockCipher
{
     ...
     * \AlonePack\Phpseclib3\Crypt\Rijndael determines automatically whether mcrypt is useable
     * or not for the current $block_size/$key_length.
     * In case of, $cipher_name_mcrypt will be set dynamically at run time accordingly.
     *
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::cipher_name_mcrypt
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::engine
