 ...
 *
 * $private = \AlonePack\Phpseclib3\Crypt\EC::createKey('secp256k1');
...
use AlonePack\Phpseclib3\Crypt\EC\BaseCurves\Montgomery as MontgomeryCurve;
use AlonePack\Phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use AlonePack\Phpseclib3\Crypt\EC\Curves\Curve25519;
use AlonePack\Phpseclib3\Crypt\EC\Curves\Ed25519;
use AlonePack\Phpseclib3\Crypt\EC\Curves\Ed448;
use AlonePack\Phpseclib3\Crypt\EC\Formats\Keys\PKCS1;
use AlonePack\Phpseclib3\Crypt\EC\Parameters;
use AlonePack\Phpseclib3\Crypt\EC\PrivateKey;
use AlonePack\Phpseclib3\Crypt\EC\PublicKey;
...
use AlonePack\Phpseclib3\Exception\UnsupportedOperationException;
use AlonePack\Phpseclib3\File\ASN1;
use AlonePack\Phpseclib3\File\ASN1\Maps\ECParameters;
...
abstract class EC extends AsymmetricKey
{
    ...
    public static function createKey($curve)
    {
        ...
        $curve = '\AlonePack\Phpseclib3\Crypt\EC\Curves\\' . $curveName;
