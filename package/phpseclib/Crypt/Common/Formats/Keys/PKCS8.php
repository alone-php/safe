...
namespace AlonePack\Phpseclib3\Crypt\Common\Formats\Keys;

use AlonePack\Phpseclib3\Common\Functions\Strings;
use AlonePack\Phpseclib3\Crypt\AES;
use AlonePack\Phpseclib3\Crypt\DES;
use AlonePack\Phpseclib3\Crypt\Random;
use AlonePack\Phpseclib3\Crypt\RC2;
use AlonePack\Phpseclib3\Crypt\RC4;
use AlonePack\Phpseclib3\Crypt\TripleDES;
...
abstract class PKCS8 extends PKCS
{
     ...
     *
     * @return \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey
     * @param string $algo
     */
