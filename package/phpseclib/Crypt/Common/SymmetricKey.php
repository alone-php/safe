...
/**
 * Base Class for all \AlonePack\Phpseclib3\Crypt\* cipher classes
 *
 * PHP version 5
 *
 ...
 *
 *  - The new \AlonePack\Phpseclib3\Crypt\* cipher class should extend \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey
...
namespace AlonePack\Phpseclib3\Crypt\Common;
...
use AlonePack\Phpseclib3\Exception\BadDecryptionException;
use AlonePack\Phpseclib3\Exception\BadModeException;
use AlonePack\Phpseclib3\Exception\InconsistentSetupException;
...
use AlonePack\Phpseclib3\Math\BinaryField;
use AlonePack\Phpseclib3\Math\PrimeField;
...
abstract class SymmetricKey
{
     ...
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::encrypt()
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::decrypt()
     */
    const MODE_CTR = -1;
    /**
     ...
     * Mode Map
     *
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::__construct()
     */
    const MODE_MAP = [
        'ctr'    => self::MODE_CTR,
        'ecb'    => self::MODE_ECB,
     ...
     * Engine Reverse Map
     *
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::getEngine()
     */
    const ENGINE_MAP = [
     ...
     *
     * @see \AlonePack\Phpseclib3\Crypt\Twofish::setKey()
     * @see \AlonePack\Phpseclib3\Crypt\Twofish::setIV()
     * @var bool
     */
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \AlonePack\Phpseclib3\Crypt\*() object changes after each
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \AlonePack\Phpseclib3\Crypt\* class
     *
     * @param string $in
     * @return string
     */
     ...
     *
     * Note: Must extend by the child \AlonePack\Phpseclib3\Crypt\* class
     *
     * @see self::setup()
     */
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \AlonePack\Phpseclib3\Crypt\* class.
     ...
     *    </code>
     *
     *    See also the \AlonePack\Phpseclib3\Crypt\*::_setupInlineCrypt()'s for
                    ...
                    if (strlen($_buffer["ciphertext"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            if (strlen($_block) > strlen($_buffer["ciphertext"])) {
                                $in = $_xor;
                                ' . $encrypt_block . '
                                \AlonePack\Phpseclib3\Common\Functions\Strings::increment_str($_xor);
                                $_buffer["ciphertext"].= $in;
                            }
                            $_key = \AlonePack\Phpseclib3\Common\Functions\Strings::shift($_buffer["ciphertext"], ' . $block_size . ');
                ...
                $encrypt = $init_encrypt . '
                    ...
                    if (strlen($_buffer["xor"])) {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
                            ...
                            $_key = \AlonePack\Phpseclib3\Common\Functions\Strings::shift($_buffer["xor"], ' . $block_size . ');
                            $_ciphertext.= $_block ^ $_key;
                        }
                    } else {
                        for ($_i = 0; $_i < $_plaintext_len; $_i+= ' . $block_size . ') {
