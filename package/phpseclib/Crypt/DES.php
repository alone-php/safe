 ...
 *
 *    $des = new \AlonePack\Phpseclib3\Crypt\DES('ctr');
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends BlockCipher
{
     ...
     * @see \AlonePack\Phpseclib3\Crypt\DES::processBlock()
     */
    const ENCRYPT = 0;
    /**
     ...
     *
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::openssl_mode_names
     * @var array
     */
     ...
     *
     * @see \AlonePack\Phpseclib3\Crypt\Common\SymmetricKey::isValidEngine()
     * @param int $engine
     * @return bool
     */
