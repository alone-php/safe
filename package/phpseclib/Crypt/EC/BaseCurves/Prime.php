...
namespace AlonePack\Phpseclib3\Crypt\EC\BaseCurves;

use AlonePack\Phpseclib3\Common\Functions\Strings;
use AlonePack\Phpseclib3\Math\BigInteger;
use AlonePack\Phpseclib3\Math\Common\FiniteField\Integer;
use AlonePack\Phpseclib3\Math\PrimeField;
use AlonePack\Phpseclib3\Math\PrimeField\Integer as PrimeInteger;
...
class Prime extends Base
{
     ...
     *
     * @var \AlonePack\Phpseclib3\Math\PrimeFields
     */
    protected $factory;
     ...
     * you do (x / z^2, y / z^3)
     *
     * @return \AlonePack\Phpseclib3\Math\PrimeField\Integer[]
     */
