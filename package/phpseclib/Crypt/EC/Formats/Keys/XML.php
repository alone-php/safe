...
use AlonePack\Phpseclib3\Crypt\EC\BaseCurves\Prime as PrimeCurve;
use AlonePack\Phpseclib3\Crypt\EC\BaseCurves\TwistedEdwards as TwistedEdwardsCurve;
use AlonePack\Phpseclib3\Exception\BadConfigurationException;
...
abstract class XML
{
    ...
    /**
     * Returns an instance of \AlonePack\Phpseclib3\Crypt\EC\BaseCurves\Base based
    ...
    private static function loadCurveByParam(\DOMXPath $xpath)
    {
        ...
        if ($namedCurve->length == 1) {
            ...
            $curve = '\AlonePack\Phpseclib3\Crypt\EC\Curves\\' . $name;
