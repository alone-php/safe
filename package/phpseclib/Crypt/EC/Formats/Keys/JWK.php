...
namespace AlonePack\Phpseclib3\Crypt\EC\Formats\Keys;

use AlonePack\Phpseclib3\Common\Functions\Strings;
use AlonePack\Phpseclib3\Crypt\Common\Formats\Keys\JWK as Progenitor;
use AlonePack\Phpseclib3\Crypt\EC\BaseCurves\Base as BaseCurve;
...
use AlonePack\Phpseclib3\Crypt\EC\Curves\secp256k1;
use AlonePack\Phpseclib3\Crypt\EC\Curves\secp256r1;
use AlonePack\Phpseclib3\Crypt\EC\Curves\secp384r1;
use AlonePack\Phpseclib3\Crypt\EC\Curves\secp521r1;
...
abstract class JWK extends Progenitor
{
    ...
    public static function load($key, $password = '')
    {
        ...
        $curve = '\AlonePack\Phpseclib3\Crypt\EC\Curves\\' . str_replace('P-', 'nistp', $key->crv);
        $curve = new $curve();
     ...
     * @param \AlonePack\Phpseclib3\Math\Common\FiniteField\Integer[] $publicKey
     * @return array
     */
